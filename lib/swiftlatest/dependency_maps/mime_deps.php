...
SwiftUpgrade_DependencyContainer::getInstance()
    ...
    ->asSharedInstanceOf('SwiftUpgrade_Mime_Grammar')

    ->register('mime.message')
    ->asNewInstanceOf('SwiftUpgrade_Mime_SimpleMessage')
    ...
    ->register('mime.part')
    ->asNewInstanceOf('SwiftUpgrade_Mime_MimePart')
    ->withDependencies(array(
        'mime.headerset',
        'mime.qpcontentencoder',
        'cache',
    ...
    ->asNewInstanceOf('SwiftUpgrade_Mime_Attachment')
    ->withDependencies(array(
        'mime.headerset',
    ...
    ->asNewInstanceOf('SwiftUpgrade_Mime_EmbeddedFile')
    ->withDependencies(array(
        'mime.headerset',
        'mime.base64contentencoder',
        'cache',
    ...
    ->asNewInstanceOf('SwiftUpgrade_Mime_SimpleHeaderFactory')
    ->withDependencies(array(
    ...
    ->asNewInstanceOf('SwiftUpgrade_Mime_SimpleHeaderSet')
    ->withDependencies(array('mime.headerfactory', 'properties.charset'))

    ->register('mime.qpheaderencoder')
    ->asNewInstanceOf('SwiftUpgrade_Mime_HeaderEncoder_QpHeaderEncoder')
    ->withDependencies(array('mime.charstream'))

    ->register('mime.base64headerencoder')
    ->asNewInstanceOf('SwiftUpgrade_Mime_HeaderEncoder_Base64HeaderEncoder')
    ->withDependencies(array('mime.charstream'))

    ->register('mime.charstream')
    ->asNewInstanceOf('SwiftUpgrade_CharacterStream_NgCharacterStream')
    ->withDependencies(array('mime.characterreaderfactory', 'properties.charset'))

    ->register('mime.bytecanonicalizer')
    ->asSharedInstanceOf('SwiftUpgrade_StreamFilters_ByteArrayReplacementFilter')
    ...
    ->asSharedInstanceOf('SwiftUpgrade_CharacterReaderFactory_SimpleCharacterReaderFactory')

    ->register('mime.safeqpcontentencoder')
    ->asNewInstanceOf('SwiftUpgrade_Mime_ContentEncoder_QpContentEncoder')
    ->withDependencies(array('mime.charstream', 'mime.bytecanonicalizer'))

    ->register('mime.rawcontentencoder')
    ->asNewInstanceOf('SwiftUpgrade_Mime_ContentEncoder_RawContentEncoder')

    ->register('mime.nativeqpcontentencoder')
    ->withDependencies(array('properties.charset'))
    ->asNewInstanceOf('SwiftUpgrade_Mime_ContentEncoder_NativeQpContentEncoder')

    ->register('mime.qpcontentencoderproxy')
    ->asNewInstanceOf('SwiftUpgrade_Mime_ContentEncoder_QpContentEncoderProxy')
    ...
    ->asNewInstanceOf('SwiftUpgrade_Mime_ContentEncoder_PlainContentEncoder')
    ...
    ->asSharedInstanceOf('SwiftUpgrade_Mime_ContentEncoder_Base64ContentEncoder')

    ->register('mime.rfc2231encoder')
    ->asNewInstanceOf('SwiftUpgrade_Encoder_Rfc2231Encoder')
    ->withDependencies(array('mime.charstream'))
