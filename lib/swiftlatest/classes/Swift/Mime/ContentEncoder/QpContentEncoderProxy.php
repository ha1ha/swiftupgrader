 ...
 */
class SwiftUpgrade_Mime_ContentEncoder_QpContentEncoderProxy implements SwiftUpgrade_Mime_ContentEncoder
{
    /**
     * @var SwiftUpgrade_Mime_ContentEncoder_QpContentEncoder
     */
    private $safeEncoder;

    /**
     * @var SwiftUpgrade_Mime_ContentEncoder_NativeQpContentEncoder
     */
     ...
     * Constructor.
     *
     * @param SwiftUpgrade_Mime_ContentEncoder_QpContentEncoder       $safeEncoder
     * @param SwiftUpgrade_Mime_ContentEncoder_NativeQpContentEncoder $nativeEncoder
     * @param string|null                                      $charset
     */
    public function __construct(SwiftUpgrade_Mime_ContentEncoder_QpContentEncoder $safeEncoder, SwiftUpgrade_Mime_ContentEncoder_NativeQpContentEncoder $nativeEncoder, $charset)
    {
