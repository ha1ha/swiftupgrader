 ...
 * @author Chris Corbyn
 */
class SwiftUpgrade_Mime_SimpleMessage extends SwiftUpgrade_Mime_MimePart implements SwiftUpgrade_Mime_Message
{
    /**
     ...
     */
    public function __construct(SwiftUpgrade_Mime_HeaderSet $headers, SwiftUpgrade_Mime_ContentEncoder $encoder, SwiftUpgrade_KeyCache $cache, SwiftUpgrade_Mime_Grammar $grammar, $charset = null)
    {
    ...
    /**
     * Attach a {@link SwiftUpgrade_Mime_MimeEntity} such as an Attachment or MimePart.
     *
     * @param SwiftUpgrade_Mime_MimeEntity $entity
     *
     * @return SwiftUpgrade_Mime_SimpleMessage
     */
    public function attach(SwiftUpgrade_Mime_MimeEntity $entity)
    {
     ...
     * @return SwiftUpgrade_Mime_SimpleMessage
     */
    public function detach(SwiftUpgrade_Mime_MimeEntity $entity)
    {
        $newChildren = array();
    ...
    /**
     * Attach a {@link SwiftUpgrade_Mime_MimeEntity} and return it's CID source.
     ...
     * @return string
     */
    public function embed(SwiftUpgrade_Mime_MimeEntity $entity)
    {
        $this->attach($entity);
