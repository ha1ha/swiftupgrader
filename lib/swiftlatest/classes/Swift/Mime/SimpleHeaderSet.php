 ...
 * @author Chris Corbyn
 */
class SwiftUpgrade_Mime_SimpleHeaderSet implements SwiftUpgrade_Mime_HeaderSet
{
    /** HeaderFactory */
    private $_factory;
     ...
     *
     * @param SwiftUpgrade_Mime_HeaderFactory $factory
     * @param string                   $charset
     */
    public function __construct(SwiftUpgrade_Mime_HeaderFactory $factory, $charset = null)
    {
     ...
     * @param int               $index
     */
    public function set(SwiftUpgrade_Mime_Header $header, $index = 0)
    {
    ...
    private function _storeHeader($name, SwiftUpgrade_Mime_Header $header, $offset = null)
    {
    ...
    private function _isDisplayed(SwiftUpgrade_Mime_Header $header)
    {
