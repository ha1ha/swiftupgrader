 ...
 * @author Chris Corbyn
 */
class SwiftUpgrade_Mime_Attachment extends SwiftUpgrade_Mime_SimpleMimeEntity
{
     ...
     *
     * @param SwiftUpgrade_FileStream $file
     * @param string           $contentType optional
     *
     * @return Swift_Mime_Attachment
     */
    public function setFile(SwiftUpgrade_FileStream $file, $contentType = null)
    {
