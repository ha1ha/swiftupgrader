 ...
 * @author Chris Corbyn
 */
abstract class SwiftUpgrade_Mime_Headers_AbstractHeader implements SwiftUpgrade_Mime_Header
{
    /**
     ...
     */
    public function __construct(SwiftUpgrade_Mime_Grammar $grammar)
    {
     ...
     */
    public function setEncoder(SwiftUpgrade_Mime_HeaderEncoder $encoder)
    {
     ...
     *
     * @return SwiftUpgrade_Mime_HeaderEncoder
     */
     ...
     * @param Swift_Mime_Grammar $grammar
     */
    public function setGrammar(SwiftUpgrade_Mime_Grammar $grammar)
    {
     ...
     *
     * @param SwiftUpgrade_Mime_Header        $header
     ...
     * @return string
     */
    protected function createPhrase(SwiftUpgrade_Mime_Header $header, $string, $charset, SwiftUpgrade_Mime_HeaderEncoder $encoder = null, $shorten = false)
    {
     ...
     * @return string
     */
    protected function encodeWords(SwiftUpgrade_Mime_Header $header, $input, $usedLength = -1)
    {
        $value = '';
