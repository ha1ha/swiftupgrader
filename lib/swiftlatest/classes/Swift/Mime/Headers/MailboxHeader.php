 ...
 * @author Chris Corbyn
 */
class SwiftUpgrade_Mime_Headers_MailboxHeader extends SwiftUpgrade_Mime_Headers_AbstractHeader
{
    /**
     ...
     */
    public function __construct($name, SwiftUpgrade_Mime_HeaderEncoder $encoder, SwiftUpgrade_Mime_Grammar $grammar)
    {
     ...
     * <code>
     * <?php
     * $header = new SwiftUpgrade_Mime_Headers_MailboxHeader('From',
     ...
     *
     * @throws SwiftUpgrade_RfcComplianceException If invalid.
     */
    private function _assertValidAddress($address)
    {
        if (!preg_match('/^'.$this->getGrammar()->getDefinition('addr-spec').'$/D',
            $address)) {
            throw new SwiftUpgrade_RfcComplianceException(
