 ...
 * @author Chris Corbyn
 */
class SwiftUpgrade_Mime_Headers_ParameterizedHeader extends SwiftUpgrade_Mime_Headers_UnstructuredHeader implements SwiftUpgrade_Mime_ParameterizedHeader
{
    /**
     ...
     */
    public function __construct($name, SwiftUpgrade_Mime_HeaderEncoder $encoder, SwiftUpgrade_Encoder $paramEncoder = null, SwiftUpgrade_Mime_Grammar $grammar)
    {
