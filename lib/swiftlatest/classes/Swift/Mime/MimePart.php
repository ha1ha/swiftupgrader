 ...
 * @author Chris Corbyn
 */
class SwiftUpgrade_Mime_MimePart extends SwiftUpgrade_Mime_SimpleMimeEntity
{
     ...
     *
     * @return SwiftUpgrade_Mime_MimePart
     */
    ...
    protected function _convertString($string)
    {
        ...
        if (!in_array($charset, array('utf-8', 'iso-8859-1', ''))) {
            ...
            if (function_exists('mb_convert_encoding')) {
                ...
                throw new SwiftUpgrade_SwiftException('No suitable convert encoding function (use UTF-8 as your charset or install the mbstring or iconv extension).');
            }
