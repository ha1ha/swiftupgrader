 ...
 * @author Chris Corbyn
 */
class SwiftUpgrade_StreamFilters_StringReplacementFilterFactory implements SwiftUpgrade_ReplacementFilterFactory
{
    /** Lazy-loaded filters */
     ...
     *
     * @return SwiftUpgrade_StreamFilter
     */
    public function createFilter($search, $replace)
    {
        if (!isset($this->_filters[$search][$replace])) {
            ...
            $this->_filters[$search][$replace] = new SwiftUpgrade_StreamFilters_StringReplacementFilter($search, $replace);
        }
