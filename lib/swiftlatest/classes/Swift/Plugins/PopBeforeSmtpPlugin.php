 ...
 * @author Chris Corbyn
 */
class SwiftUpgrade_Plugins_PopBeforeSmtpPlugin implements SwiftUpgrade_Events_TransportChangeListener, SwiftUpgrade_Plugins_Pop_Pop3Connection
{
     ...
     * @param string $crypto as "tls" or "ssl"
     *
     * @return SwiftUpgrade_Plugins_PopBeforeSmtpPlugin
     */
     ...
     *
     * @param SwiftUpgrade_Plugins_Pop_Pop3Connection $connection
     *
     * @return SwiftUpgrade_Plugins_PopBeforeSmtpPlugin
     */
    public function setConnection(SwiftUpgrade_Plugins_Pop_Pop3Connection $connection)
    {
     ...
     *
     * @param SwiftUpgrade_Transport
     */
    public function bindSmtp(SwiftUpgrade_Transport $smtp)
    {
     ...
     *
     * @throws SwiftUpgrade_Plugins_Pop_Pop3Exception if connection fails
     */
        ...
        if (isset($this->_connection)) {
            ...
            if (!isset($this->_socket)) {
                if (!$socket = fsockopen(
                    ...
                    throw new SwiftUpgrade_Plugins_Pop_Pop3Exception(
