 ...
 * @author Chris Corbyn
 */
class SwiftUpgrade_Plugins_AntiFloodPlugin implements SwiftUpgrade_Events_SendListener, SwiftUpgrade_Plugins_Sleeper
{
    /**
     ...
     * @param SwiftUpgrade_Plugins_Sleeper $sleeper   (not needed really)
     */
    public function __construct($threshold = 99, $sleep = 0, SwiftUpgrade_Plugins_Sleeper $sleeper = null)
    {
