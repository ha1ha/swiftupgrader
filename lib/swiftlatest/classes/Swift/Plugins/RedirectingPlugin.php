 ...
 */
class SwiftUpgrade_Plugins_RedirectingPlugin implements SwiftUpgrade_Events_SendListener
{
    /**
     ...
     *
     * @param SwiftUpgrade_Mime_HeaderSet $headerSet
     * @param string               $type
     */
    private function _filterHeaderSet(SwiftUpgrade_Mime_HeaderSet $headerSet, $type)
    {
