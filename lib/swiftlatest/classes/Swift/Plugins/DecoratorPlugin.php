 ...
 */
class SwiftUpgrade_Plugins_DecoratorPlugin implements SwiftUpgrade_Events_SendListener, SwiftUpgrade_Plugins_Decorator_Replacements
{
    /** The replacement map */
     ...
     * of {@link SwiftUpgrade_Plugins_Decorator_Replacements}.
     *
     ...
     * </code>
     *
     * When using an instance of {@link SwiftUpgrade_Plugins_Decorator_Replacements},
     * the object should return just the array of replacements for the address
     * given to {@link SwiftUpgrade_Plugins_Decorator_Replacements::getReplacementsFor()}.
     *
     * @param mixed $replacements Array or SwiftUpgrade_Plugins_Decorator_Replacements
     */
    ...
    {
        if (!($replacements instanceof SwiftUpgrade_Plugins_Decorator_Replacements)) {
     ...
     * {@link SwiftUpgrade_Plugins_Decorator_Replacements} then the call will be
    ...
    {
        if ($this->_replacements instanceof SwiftUpgrade_Plugins_Decorator_Replacements) {
    ...
    private function _restoreMessage(SwiftUpgrade_Mime_Message $message)
    {
