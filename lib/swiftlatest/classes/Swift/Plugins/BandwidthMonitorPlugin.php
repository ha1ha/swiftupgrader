 ...
 * @author Chris Corbyn
 */
class SwiftUpgrade_Plugins_BandwidthMonitorPlugin implements SwiftUpgrade_Events_SendListener, SwiftUpgrade_Events_CommandListener, SwiftUpgrade_Events_ResponseListener, SwiftUpgrade_InputByteStream
{
    /**
