 ...
 * @author Chris Corbyn
 */
class SwiftUpgrade_Plugins_ThrottlerPlugin extends SwiftUpgrade_Plugins_BandwidthMonitorPlugin implements SwiftUpgrade_Plugins_Sleeper, SwiftUpgrade_Plugins_Timer
{
     ...
     *
     * @var SwiftUpgrade_Plugins_Sleeper
     */
    private $_sleeper;
     ...
     *
     * @var SwiftUpgrade_Plugins_Timer
     */
    private $_timer;
     ...
     * @param SwiftUpgrade_Plugins_Sleeper $sleeper (only needed in testing)
     * @param SwiftUpgrade_Plugins_Timer   $timer   (only needed in testing)
     */
    public function __construct($rate, $mode = self::BYTES_PER_MINUTE, SwiftUpgrade_Plugins_Sleeper $sleeper = null, SwiftUpgrade_Plugins_Timer $timer = null)
    {
        $this->_rate = $rate;
        $this->_mode = $mode;
