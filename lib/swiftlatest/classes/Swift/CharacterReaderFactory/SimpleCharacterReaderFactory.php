 ...
 * @author Chris Corbyn
 */
class SwiftUpgrade_CharacterReaderFactory_SimpleCharacterReaderFactory implements SwiftUpgrade_CharacterReaderFactory
{
    /**
    ...
    public function init()
    {
        ...
        $prefix = 'SwiftUpgrade_CharacterReader_';
