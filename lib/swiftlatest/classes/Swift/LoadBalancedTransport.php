 ...
 * @author Chris Corbyn
 */
class SwiftUpgrade_LoadBalancedTransport extends SwiftUpgrade_Transport_LoadBalancedTransport
{
    /**
    ...
    public function __construct($transports = array())
    {
        call_user_func_array(
            array($this, 'SwiftUpgrade_Transport_LoadBalancedTransport::__construct'),
