 ...
 * @author Chris Corbyn
 */
class SwiftUpgrade_Transport_StreamBuffer extends SwiftUpgrade_ByteStream_AbstractFilterableInputStream implements SwiftUpgrade_Transport_IoBuffer
{
    /** A primary socket */
    private $_stream;
     ...
     */
    public function __construct(SwiftUpgrade_ReplacementFilterFactory $replacementFactory)
    {
