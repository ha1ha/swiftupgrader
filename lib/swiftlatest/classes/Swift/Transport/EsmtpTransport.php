 ...
 * @author Chris Corbyn
 */
class SwiftUpgrade_Transport_EsmtpTransport extends SwiftUpgrade_Transport_AbstractSmtpTransport implements SwiftUpgrade_Transport_SmtpAgent
{
    /**
     * ESMTP extension handlers.
     *
     * @var SwiftUpgrade_Transport_EsmtpHandler[]
     */
    ...
    private $_params = array(
        ...
        'blocking' => 1,
        'tls' => false,
        'type' => SwiftUpgrade_Transport_IoBuffer::TYPE_SOCKET,
     ...
     * @param SwiftUpgrade_Transport_EsmtpHandler[] $extensionHandlers
     * @param Swift_Events_EventDispatcher   $dispatcher
     */
    public function __construct(SwiftUpgrade_Transport_IoBuffer $buf, array $extensionHandlers, SwiftUpgrade_Events_EventDispatcher $dispatcher)
    {
     ...
     * @param string $host
     *
     * @return SwiftUpgrade_Transport_EsmtpTransport
     */
     ...
     *
     * @param SwiftUpgrade_Transport_EsmtpHandler[] $handlers
     *
     * @return SwiftUpgrade_Transport_EsmtpTransport
     */
     ...
     *
     * @return SwiftUpgrade_Transport_EsmtpHandler[]
     */
        ...
        if ($this->_params['tls']) {
            try {
                ...
                if (!$this->_buffer->startTLS()) {
                    throw new SwiftUpgrade_TransportException('Unable to connect with TLS encryption');
                }
