 ...
 * @author Chris Corbyn
 */
class SwiftUpgrade_Transport_MailTransport implements SwiftUpgrade_Transport
{
     ...
     *
     * @param SwiftUpgrade_Transport_MailInvoker  $invoker
     * @param Swift_Events_EventDispatcher $eventDispatcher
     */
    public function __construct(SwiftUpgrade_Transport_MailInvoker $invoker, SwiftUpgrade_Events_EventDispatcher $eventDispatcher)
    {
     ...
     * @param string $params
     *
     * @return SwiftUpgrade_Transport_MailTransport
     */
    ...
    public function send(SwiftUpgrade_Mime_Message $message, &$failedRecipients = null)
    {
        ...
        if (!$toHeader) {
            $this->_throwException(new SwiftUpgrade_TransportException('Cannot send message without a recipient'));
        }
    ...
    private function _getReversePath(SwiftUpgrade_Mime_Message $message)
    {
