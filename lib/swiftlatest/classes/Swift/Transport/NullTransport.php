 ...
 */
class SwiftUpgrade_Transport_NullTransport implements SwiftUpgrade_Transport
{
     ...
     * Constructor.
     */
    public function __construct(SwiftUpgrade_Events_EventDispatcher $eventDispatcher)
    {
