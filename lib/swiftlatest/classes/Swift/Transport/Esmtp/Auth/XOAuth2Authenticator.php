 ...
 */
class SwiftUpgrade_Transport_Esmtp_Auth_XOAuth2Authenticator implements SwiftUpgrade_Transport_Esmtp_Authenticator
{
    /**
     ...
     * @return bool
     */
    public function authenticate(SwiftUpgrade_Transport_SmtpAgent $agent, $email, $token)
    {
        try {
