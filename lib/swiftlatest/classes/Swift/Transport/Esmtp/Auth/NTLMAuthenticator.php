 ...
 */
class SwiftUpgrade_Transport_Esmtp_Auth_NTLMAuthenticator implements SwiftUpgrade_Transport_Esmtp_Authenticator
{
     ...
     */
    protected function sendMessage1(SwiftUpgrade_Transport_SmtpAgent $agent)
    {
     ...
     * @return string
     */
    protected function sendMessage3($response, $username, $password, $timestamp, $client, SwiftUpgrade_Transport_SmtpAgent $agent, $v2 = true)
    {
