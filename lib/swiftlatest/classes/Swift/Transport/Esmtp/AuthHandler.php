 ...
 * @author Chris Corbyn
 */
class SwiftUpgrade_Transport_Esmtp_AuthHandler implements SwiftUpgrade_Transport_EsmtpHandler
{
    /**
     * Authenticators available to process the request.
     *
     * @var SwiftUpgrade_Transport_Esmtp_Authenticator[]
     */
     ...
     *
     * @param SwiftUpgrade_Transport_Esmtp_Authenticator[] $authenticators
     */
     ...
     *
     * @return SwiftUpgrade_Transport_Esmtp_Authenticator[]
     */
     ...
     *
     * @param SwiftUpgrade_Transport_SmtpAgent $agent to read/write
     */
    public function afterEhlo(SwiftUpgrade_Transport_SmtpAgent $agent)
    {
        if ($this->_username) {
            $count = 0;
     ...
     * Not used.
     */
    public function onCommand(SwiftUpgrade_Transport_SmtpAgent $agent, $command, $codes = array(), &$failedRecipients = null, &$stop = false)
    {
    }
    ...
    protected function _getAuthenticatorsForAgent()
    {
        ...
        throw new SwiftUpgrade_TransportException('Auth mode '.$mode.' is invalid');
    }
}
