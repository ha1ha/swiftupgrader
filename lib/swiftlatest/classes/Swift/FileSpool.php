 ...
 */
class SwiftUpgrade_FileSpool extends SwiftUpgrade_ConfigurableSpool
{
    /** The spool directory */
    private $_path;
    ...
    public function __construct($path)
    {
        ...
        if (!file_exists($this->_path)) {
            if (!mkdir($this->_path, 0777, true)) {
                throw new SwiftUpgrade_IoException('Unable to create Path ['.$this->_path.']');
            }
        }
    }
    ...
    public function queueMessage(SwiftUpgrade_Mime_Message $message)
    {
        ...
        throw new SwiftUpgrade_IoException('Unable to create a file for enqueuing Message');
    }
