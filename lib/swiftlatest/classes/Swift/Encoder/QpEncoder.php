 ...
 * @author Chris Corbyn
 */
class SwiftUpgrade_Encoder_QpEncoder implements SwiftUpgrade_Encoder
{
    /**
     * The CharacterStream used for reading characters (as opposed to bytes).
     *
     * @var SwiftUpgrade_CharacterStream
     */
     ...
     * @param SwiftUpgrade_StreamFilter    $filter     if input should be canonicalized
     */
    public function __construct(SwiftUpgrade_CharacterStream $charStream, SwiftUpgrade_StreamFilter $filter = null)
    {
