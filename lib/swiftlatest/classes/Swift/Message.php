 ...
 * @author Chris Corbyn
 */
class SwiftUpgrade_Message extends SwiftUpgrade_Mime_SimpleMessage
{
    /**
     * @var SwiftUpgrade_Signers_HeaderSigner[]
     */
    private $headerSigners = array();

    /**
     * @var SwiftUpgrade_Signers_BodySigner[]
     */
    ...
    public function __construct($subject = null, $body = null, $contentType = null, $charset = null)
    {
        call_user_func_array(
            array($this, 'SwiftUpgrade_Mime_SimpleMessage::__construct'),
            SwiftUpgrade_DependencyContainer::getInstance()
                ->createDependenciesFor('mime.message')
            );

        if (!isset($charset)) {
            $charset = SwiftUpgrade_DependencyContainer::getInstance()
     ...
     *
     * @param string|SwiftUpgrade_OutputByteStream $body
     * @param string                        $contentType
     * @param string                        $charset
     *
     * @return SwiftUpgrade_Mime_SimpleMessage
     */
    public function addPart($body, $contentType = null, $charset = null)
    {
        return $this->attach(SwiftUpgrade_MimePart::newInstance(
     ...
     *
     * @param SwiftUpgrade_Signer $signer
     *
     * @return Swift_Message
     */
    public function attachSigner(SwiftUpgrade_Signer $signer)
    {
        if ($signer instanceof SwiftUpgrade_Signers_HeaderSigner) {
            $this->headerSigners[] = $signer;
        } elseif ($signer instanceof SwiftUpgrade_Signers_BodySigner) {
     ...
     * @return Swift_Message
     */
    public function detachSigner(SwiftUpgrade_Signer $signer)
    {
        if ($signer instanceof SwiftUpgrade_Signers_HeaderSigner) {
    ...
    /**
     * Write this message to a {@link SwiftUpgrade_InputByteStream}.
     *
    ...
    {
        SwiftUpgrade_DependencyContainer::getInstance()->createDependenciesFor('mime.message');
    }
