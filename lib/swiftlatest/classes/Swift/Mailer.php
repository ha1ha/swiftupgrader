...
class SwiftUpgrade_Mailer
{
     ...
     */
    public function __construct(SwiftUpgrade_Transport $transport)
    {
     ...
     * @return Swift_Mailer
     */
    public static function newInstance(SwiftUpgrade_Transport $transport)
    {
    ...
    {
        return SwiftUpgrade_DependencyContainer::getInstance()
