 ...
 * @author Chris Corbyn
 */
class SwiftUpgrade_Events_SendEvent extends SwiftUpgrade_Events_EventObject
{
     ...
     */
    public function __construct(SwiftUpgrade_Transport $source, SwiftUpgrade_Mime_Message $message)
    {
     ...
     *
     * @return SwiftUpgrade_Mime_Message
     */
